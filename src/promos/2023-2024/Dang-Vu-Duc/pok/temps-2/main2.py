...
print(test.solve('3R4/RB2k3/2Q2p2/B4P2/2r3K1/8/8/8 w - - 0 1', True, 3))
...
# test.board = test.get_position_from_fen('rnbqk1nr/pppp1ppp/8/4p3/1b1PP3/8/PPPB1PPP/RN1QKBNR w KQkq - 0 1')[0]
