...
3. **Conception avec Figma**
   ...
   3.3. Collaborer avec l'équipe ou des parties prenantes pour obtenir des commentaires et des révisions.
   3.4. Finaliser les maquettes et les rendre prêtes pour le développement.
...
5. **Livraison**
   5.1. Mettre en ligne le projet, que ce soit sur un serveur de développement ou en production.
