...
- Méthode Prince2 en détail : Elaborer le Projet :: PRINCE2® wiki. https://prince2.wiki/fr/processus/elaborer-le-projet/.
...
- [ ] Brainstorming personnel sur les problèmes rencontrés dans des cas de choix d'outils de GdP.
- [ ] Brainstorming général d'identification des axes de travail, des questionnements et des enjeux.
...
- [ ] Conception d'un formulaire :
  - [ ] Aspect typologie de projet
    - [ ] Différenciation tâche/projet
    - [ ] Typologie temporelle
    - [ ] Typologie par importance (strat ? € ?...)
    - [ ] Typologie par taille
    - [ ] Typologie par équipe projet
  - [ ] Aspect besoin de gestion
  - [ ] Aspect outils utilisés et pourquoi ?
  - [ ] Aspect pression extérieur
- [ ] Révision du formulaire avec L.Piet
- [ ] Envoie du formulaire
- [ ] Rédaction des présupposés
...
- [ ] Conception d'une grille de caractérisation des outils
  - [ ] Brainstorming caractéristiques à utiliser
  - [ ] Format de la grille
- [ ] Remplissage de la grille
- [ ] Conception d'une grille de caractérisation par typologie de projet
- [ ] Remplissage de la grille

| Date | Heures passées | Indications | Niveau d'efficacité |
| -------- | -------- | -------- | -------- |
| 13/01/2025 | xxh | Lorem ipsum | Lorem Ipsum |
...
**DIMENSIONNEMENT DES TACHES :** Lorem Ipsum  
{% enddetails %}
...
Après avoir menée une démarche instrospective tout au long de ce POK je suis arrivé aux conclusions suivantes :
1. Je souhaite organiser l'ensemble de mon travail en mode projet.
{% details "Pourquoi ?" %}
Pouvant être mobilisé sur plusieurs projets et tâches opérationnelles simultannéement, l'oganisation en mode projet convient à mes méthode de travail. En considérant mon poste comme étant un projet ou même un programme à part entière, je peux :
- Plannifier mon travail
- Identifier l'avancement de mes tâches
- Identifier et prévenir les différents risques gravitant autours de mon postes, tâches et projets
...
2. Les besoins principaux pour le suivi de mes activités professionnels sont : Formaliser, plannifier, anticiper, identifier et capitaliser.

{% details "Pourquoi ?" %}  
| Besoin | Détail | Besoin psychologique et méthodologique |
|--------|--------|----------------------------------------|
| Formaliser | Clarifier les différentes demandes qui me sont adressées au travers de chartes projets, cahiers des charges...| Ce besoin provient d'un besoin fort d'avoir une vue à la fois d'ensemble et précise des tâches que je fois réaliser. Mon niveau de motivation et d'efficacité y sont très liés|
| Plannifier | Fixer deadlines, périodes de travail et jalons | Identifier le temps restant et disponible à la réalisation de mon travail me permet de limiter mon stress ainsi que la remise en question perpétuelle de mes activités |
| Anticiper | Identifier les risques, les forces, les faiblesses de mon travail | Permet de limiter la durée de réflexion et de stress lors d'incidents ou d'imprévus |
| Identifier | Identifier les enjeux, les compétences (détenues ou manquantes) et les points stratégiques | Permet de répondre à ma quête de sens d'optimiser mon propre engouement pour mon travail |
| Capitaliser | Automatiser et industrialiser la production et réutilisation de REX | Permet de limiter la frustration de réaliser les mêmes tâches ou erreures plusieurs fois. Permet également de maintenir un engouement en favorisant un apprentissage continu. |
{% enddetails %}

### 1.2 Les enjeux

Mettre en place une méthode de travail permettant de lier chacune de mes activités suppose d'avoir connaissance des différentes typologies de tâhces qui pourront m'incomber. J'ai donc identifier 4 cas de figure :

**Cas N°1 :** Membre d'une équipe projet, sans en être le gestionnaire. Le chef de projet mène une gestion de projet complète : documents de cadrage, de conception, de plannification partagées, validés et suivis.  
**Cas N°2 :** Membre d'une équipe projet, sans en être le gestionnaire. Le chef de projet **NE** mène **PAS** gestop, de projet complète : PAS de documents de cadrage, de conception, de plannification partagées, validés et suivis.  
...
#### La méthode
D'après https://www.planzone.fr/blog/quest-ce-que-la-methodologie-prince2, la méthode Prince2 (PRojects IN Controlled Environments) est "[...]une méthode pragmatique, structurée, évolutive et adaptable qui permet d'organiser, de gérer et de contrôler efficacement tous types de projets, quelle que soit sa taille."  
"PRINCE2 se base sur :
...
**D'après : https://www.leblogdudirigeant.com/la-methode-de-gestion-de-projet-prince2/**
- Les processus ne peuvent prendre en compte tous les cas de figure. Manquer de pragamatisme et rester focaliser sur la méthode peut altérer la qualité de la gestion du projet.


**D'après : https://www.furious-squad.com/methode-prince2/?utm_source=chatgpt.com**
- Trop complexe pour les petits projets
- Au premier abord trop rigide et procédurale
- La certification Prince2 représente un investissement dignificatif
...
Le cadrage et la conception du projet sont deux phases différentes du projet. Elle sont séparé par un Go/noGo.
**Cadrage :** Vise à fixer les grandes lignes du projet et les premières estimation d'allocation des ressources (temporelles, humaine et financières...)
**Conception :** Vise à affiner les exigences ainsi qu'à organiser le travail : Détail des exigences fonctionnelles et techniques, plannification détaillée, mobilisation des ressources huamines...
...
| 7   | Contextualisation, critérisation et objectifs | Besoin avec les différents critères de réalisation et d’appréciation du livrable | Gestionnaire | Client |
| 8   | Apprendre | | Gestionnaire | Gestionnaire |
| 9   | Tester / Mettre en application | | Gestionnaire | Gestionnaire |
| 10  | Capitaliser | Amélioration continue pour les prochains projets de l’entreprise ou dans la carrière du PM | Gestionnaire | Gestionnaire |
| 11  | Reporting | | Management | Gestionnaire |
| 12  | Approbation et avis | Le PM doit pouvoir avoir accès aux avis, enjeux des autres PP afin de pouvoir obtenir leur approbation et/ou éviter un blocage | Gestionnaire | Autres PP |
| 13  | Informations et considérations | Les PP du projet doivent se sentir écoutées, prises en compte dans la démarche du projet. Pour ne pas (pouvoir) bloquer, elles doivent être informées de la réalité des choses | Autres PP | Gestionnaire |

#### Les processus et thèmes de gestiond de projet d'après Prince2
