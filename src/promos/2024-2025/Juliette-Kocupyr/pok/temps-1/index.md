...
- [Principes de l'agile](#principes-de-lagile)
- [La transformation agile](#la-transformation-agile)
  - [Définition](#définition)
  - [Les déclencheurs](#les-déclencheurs)
  - [Étapes clés](#étapes-clés)
- [Les avantages de l'approche agile](#les-avantages-de-lapproche-agile)
- [Les difficultés rencontrées](#les-difficultés-rencontrées)
- [Etude de cas](#etude-de-cas)
  - [Spotify un modèle de l'agile à l'échelle](#spotify-un-modèle-de-lagile-à-léchelle)
...
Devenir une entreprise agile implique une transformation culturelle profonde, cela implique un vrai investissement dans le temps, de nouvelles méthodes et une dose de ténacité car les écueils seront forcément présents. La première étape du changement transformation agile d’une organisation nécessite donc de faire évoluer la culture de tous les collaborateurs. Car une l’entreprise agile représente en premier lieu un ensemble de valeurs, une façon d’être, un état d’esprit au quotidien. Il est important d’avoir conscience des changements de culture que cela demande et accepter qu’il s’agisse d’une démarche d’évolution continue.

Toute la complexité de la transformation agile consiste alors à réussir à atteindre ce difficile équilibre entre respect d’un cadre méthodologique et prise en compte des spécificités culturelles. **L’Agile, c’est 70 % de culture et 30 % d’outils.** De plus chaque transformation agile est unique, avec les enjeux business propres à l’entreprise, bien qu'elles reposent sur des principes communs.

En fonction des contextes, différents modes d’organisations peuvent être expérimentés:

- l’agilité à l’échelle et le fonctionnement en squads/tribus dans les DSI ou au sein d’autres directions (l'exemple le plus connu est l'entreprise Spotify)
...
4. Vient ensuite la capacité à mesurer et à suivre les progrès qui est primordiale dans ce processus. L’équipe, au coeur de cette transformation, doit avoir une vision claire de l’avancement du projet. Pour cela, la gestion des indicateurs clés de performance (KPI) est essentielle. Ces KPIs, spécialement conçus pour évaluer le succès de la transformation agile, doivent être suivis et analysés régulièrement.
...
![planspotify](src/promos/2024-2025/Juliette-Kocupyr/pok/temps-1/image/panspotify.png)
...
Finalement, on y reconnait une simple organisation matricielle qui reste néanmoins différent du type de matrice auquel on peut être habitué. Ici, la dimension verticale correspond au "quoi" et la dimension horizontale au "comment". La structure matricielle permet aux membres de chaque équipe d'obtenir des conseils sur "ce qu'il faut faire" et "comment bien le construire".

#### Analyse du modèle

Mais avec une transformation, il est nécessaire de revenir aux valeurs fondamentales de l'agilité pour comprendre si Spotify a réussi à s'imprégner de ces valeurs lors de son évolution.

1. Les individus et leurs interactions plus que les processus et les outils

L'organisation matricielle en équipe (squads, tribus) et transversale (chapitres, guildes).
